...
SIGNAL \dut_instance|add_instance|inst3|Y~0\ : std_logic;
...
\datau[0]\ : maxv_lcell
-- Equation(s):
-- datau(0) = DFFEAS((\datau[0]~0_combout\ & (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & (\dut_instance|add_instance|inst3|Y~0\))) # (!\datau[0]~0_combout\ & (((datau(0))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
PORT MAP (
	...
	datab => \u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\,
	datac => \dut_instance|add_instance|inst3|Y~0\,
	datad => datau(0),
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|add_instance|inst3|Y~0\ = (((dut_input[0]) # (dut_input(1))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst3|Y~0\,
	regout => dut_input(0));
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|add_instance|inst3|Y~0\,
	oe => VCC,
